...
public class ExtFlightDelaysDAO {
	...
	public List<Rotta> getRotte(Map<Integer, Airport> idMap) {
		...
		try {
			...
			while(rs.next()) {
				Airport sorgenteAirport=idMap.get(rs.getInt("ORIGIN_AIRPORT_ID"));
				Airport destinazioneAirport=idMap.get(rs.getInt("DESTINATION_AIRPORT_ID"));
			
				if(sorgenteAirport!=null && destinazioneAirport!=null) {
					rotte.add(new Rotta(sorgenteAirport, destinazioneAirport, rs.getInt("tot")));
				}else {
